...
export default ({
  ...
  <div
    className={`g-flex-col ${constants.xs[xs] || ""} ${constants.sm[sm] ||
      ""} ${constants.md[md] || ""} ${constants.lg[lg] || ""} ${constants
      .xsOffset[xsOffset] || ""} ${constants.smOffset[smOffset] ||
      ""} ${constants.mdOffset[mdOffset] || ""} ${constants.lgOffset[
      lgOffset
